...
if __name__ == "__main__":
    ...
    # modify page table so that we can exec EL1(SVC) code in EL0(USER), helpful to run original fuse func... no need
    ...
    # only bootloader is signed by our sk&pk, hook the rsa verify func to return 0 so we can load ABL/SMU signed by original AMD pk and boot x86 system... 
    write_at_offset("Milan_bl_1008_bp_psb_sev_sig.bin",0x11c10,bytes.fromhex("00207047"))
